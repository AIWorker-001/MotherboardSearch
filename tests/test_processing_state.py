...
def test_same_item_and_version_is_skipped():
    state = {"entries": [{"item_id": "123", "detector_version": "v1", "last_seen_at": "2026-08-03T00:00:00Z"}]}
    listings = [{"id": "123"}, {"id": "456"}]
...
def test_merge_records_result_and_preserves_first_seen():
    now = datetime(2026, 8, 4, tzinfo=timezone.utc)
    state = {"entries": []}
    listings = [{"id": "123", "title": "Board", "url": "https://example/123"}]
